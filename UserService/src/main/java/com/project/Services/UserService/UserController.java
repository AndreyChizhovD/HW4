package com.project.Services.UserService;
...
class UserController {
    ...
    public ResponseEntity<String> registerUser(@RequestBody com.project.Services.UserService.User user) {
    ...
    @PostMapping("/login")
    public ResponseEntity<String> loginUser(@RequestBody com.project.Services.UserService.User user) {
        try {
            connect();
            ...
            if (rs.next()) {
                ...
                if (passwordHash.equals(user.getPassword())) {
                    ...
                    java.util.Date expiresAt = new java.util.Date(System.currentTimeMillis() + 300);
